...
declare module 'ethers/contracts/contract' {
    ...
    import { MinimalProvider, Signer } from 'ethers/utils/types';
    import { EventDescription, EventFilter, Listener, Log, TransactionRequest, TransactionResponse } from 'ethers/utils/types';
    interface Bucket<T> {
        [name: string]: T;
    }
    type _EventFilter = {
...
declare module 'ethers/contracts/interface' {
    ...
    import { DeployDescription, EventDescription, FunctionDescription } from 'ethers/utils/types';
    class _Description {
...
declare module 'ethers/utils/abi-coder' {
    import { Arrayish } from 'ethers/utils/bytes';
    import { CoerceFunc, EventFragment, FunctionFragment, ParamType } from 'ethers/utils/types';
...
declare module 'ethers/utils/transaction' {
    ...
    import { Transaction, UnsignedTransaction } from 'ethers/utils/types';
...
declare module 'ethers/utils/web' {
    import { ConnectionInfo } from 'ethers/utils/types';
...
declare module 'ethers/wallet/wallet' {
    ...
    import { BigNumber } from 'ethers/utils/bignumber';
    import { Arrayish } from 'ethers/utils/bytes';
    import { BlockTag, ProgressCallback, Signer, TransactionRequest, TransactionResponse } from 'ethers/utils/types';
...
declare module 'ethers/wallet/hdnode' {
    import { Arrayish } from 'ethers/utils/bytes';
    import { Wordlist } from 'ethers/utils/types';
