...
function _parseEip5806(data) {
    const fields = (0, index_js_3.decodeRlp)((0, index_js_3.getBytes)(data).slice(1));
    (0, index_js_3.assertArgument)(Array.isArray(fields) && (fields.length === 8 || fields.length === 11), "invalid field count for transaction type: 4", "data", (0, index_js_3.hexlify)(data));
    const tx = {
        type: 4,
        chainId: handleUint(fields[0], "chainId"),
        nonce: handleNumber(fields[1], "nonce"),
...
class Transaction {
    ...
    set type(value) {
        switch (value) {
            ...
            case 4:
            case "eip-5806":
                (0, index_js_3.assertArgument)(this.#value == 0n, "Delegate transaction do not support value", "value", value);
                this.#type = 4;
                break;
            default:
    ...
    set value(value) {
        ...
        (0, index_js_3.assertArgument)(this.#type !== 4 || this.#value == 0n, "Delegate transaction do not support value", "value", value);
    }
    /**
