        ...
        if (transformed != null) {
          if (show.transformed) {
            console.log(
              "Transformed:",
              shortPath,
              padding(70 - shortPath.length),
              size,
              padding(6 - String(size).length),
              "=>",
              transformed.length
            );
          }
...
taskBundle("default", {
  filename: "ethers.js",
  dest: "dist",
  show: { transformed: true, preserved: true },
  minify: false
});

// Creates dist/ethers.js
taskBundle("default-test", {
  filename: "ethers.js",
  dest: "tests/dist",
  show: { transformed: true },
  minify: false
});

// Creates dist/ethers.min.js
taskBundle("minified", {
  filename: "ethers.min.js",
  dest: "dist",
  minify: true
});

// Creates dist/ethers.min.js
taskBundle("minified-test", {
  filename: "ethers.min.js",
  dest: "tests/dist",
  minify: true
});
