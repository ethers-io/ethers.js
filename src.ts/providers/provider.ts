...
export class Log implements LogParams {
    ...
    /**
     *  The index of the transaction that generated this log within its block.
     */
...
export interface Provider extends ContractRunner, EventEmitterable<ProviderEvent>, NameResolver {
     ...
     */
    resolveName(ensName: string, coinType?: number): Promise<null | string>;
     ...
     */
    lookupAddress(address: string, coinType?: number): Promise<null | string>;
