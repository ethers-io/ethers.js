  ...
  switch (error.status._code) {
    ...
    case 30:
      return logger.throwError(
        "insufficient funds for gas cost",
    ...
    case 7:
      return logger.throwError(
        ...
        logger_1.Logger.errors.UNKNOWN_ERROR,
        { tx: txRequest }
      );
    // invalid contract id
    case 16:
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              (0, properties_1.resolveProperties)(
  ...
  Signer.prototype.call = function (txRequest) {
    return __awaiter(this, void 0, void 0, function () {
      var tx,
        ...
        walletKey,
        signature,
        transferSignedTransactionBytes,
        response,
        error_1;
        ...
        switch (_b.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              (0, properties_1.resolveProperties)(
                this.checkTransaction(txRequest)
              ),
            ];
          case 1:
            tx = _b.sent();
          ...
          case 2:
            ...
            nodeID = sdk_1.AccountId.fromString(
              (0, address_1.asAccountString)(tx.nodeId)
            );
            ...
            if (tx.customData.usingContractAlias) {
              hederaTx.setContractId(
                sdk_1.ContractId.fromEvmAddress(0, 0, tx.to.toString())
              );
            } else {
                  ...
                  accountAmounts: [
                    {
                      ...
                      amount: sdk_1.Hbar.fromTinybars(cost)
                        .negated()
                        .toTinybars(),
                    },
                    {
            ...
            walletKey = this.isED25519Type
              ? sdk_1.PrivateKey.fromStringED25519(
            ...
            transferSignedTransactionBytes =
              proto_1.SignedTransaction.encode(signed).finish();
          ...
          case 3:
            ...
            return [
              4 /*yield*/,
              hederaTx.execute(this.provider.getHederaClient()),
            ];
          case 4:
            response = _b.sent();
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [
              4 /*yield*/,
              (0, properties_1.resolveProperties)(transaction),
            ];
          case 1:
            tx = _b.sent();
          ...
          case 4:
            ...
            chunks = splitInChunks(
              Buffer.from(contractByteCode.toString()).toString(),
              4096
            );
            fileCreate = {
              customData: {
                fileChunk: chunks[0],
                fileKey: sdk_1.PublicKey.fromString(
                  this._signingKey().compressedPublicKey
                ),
              },
            };
          ...
          case 5:
            ...
            return [
              4 /*yield*/,
              this.provider.sendTransaction(signedFileCreate),
            ];
          case 6:
            resp = _b.sent();
          ...
          case 8:
            ...
            return [
              4 /*yield*/,
              this.provider.sendTransaction(signedFileAppend),
            ];
          case 9:
            _b.sent();
            _b.label = 10;
          ...
          case 12:
            ...
            return [
              4 /*yield*/,
              this.provider.sendTransaction(signedContractCreate),
            ];
          case 13:
            return [2 /*return*/, _b.sent()];
        }
  ...
  Signer.prototype.checkTransaction = function (transaction) {
    ...
    if (!tx.nodeId) {
      ...
      if (submittableNodeIDs.length > 0) {
        tx.nodeId =
          submittableNodeIDs[
            randomNumBetween(0, submittableNodeIDs.length - 1)
          ].toString();
      } else {
        logger.throwError(
          "Unable to find submittable node ID. The signer's provider is not connected to any usable network"
        );
      }
    }
    if (tx.from == null) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
              ...
              tx.to = Promise.resolve(tx.to).then(function (to) {
                return __awaiter(_this, void 0, void 0, function () {
                  return __generator(this, function (_a) {
                    ...
                    return [
                      2 /*return*/,
                      (0, address_1.getChecksumAddress)(
                        (0, address_1.getAddressFromAccount)(to)
                      ),
                    ];
                  });
                });
          ...
          case 2:
            ...
            logger.throwError(
              "gasLimit is not provided. Cannot execute a Contract Call"
            );
            return [3 /*break*/, 5];
          case 3:
          ...
          case 4:
            if (_a.sent() === "0x") {
              logger.throwError(
                "receiver is an account. Cannot execute a Contract Call"
              );
            }
            _a.label = 5;
          case 5:
            tx.customData = __assign(__assign({}, tx.customData), {
          ...
          case 6:
            ...
            if (
              !isFileCreateOrAppend &&
              !isCreateAccount &&
              !tx.customData.isCryptoTransfer &&
              tx.gasLimit == null
            ) {
              return [
                2 /*return*/,
                logger.throwError(
                  "cannot estimate gas; transaction requires manual gas limit",
