...
describe("Zero prefixed block tag", function () {
    var provider = providerFunctions[0].create("rinkeby");
    it("eth_getBalance with blockTag", function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, provider.getBalance('0x02680640DEbf91dFF2cF51131545FCBbbEbCA0b5', '0x0281610a62b7bc11190c76e2774375feb7205baba91a3a4ff8a6a65139208cab')];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
