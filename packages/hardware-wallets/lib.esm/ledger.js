...
var logger = new ethers.utils.Logger(version);
...
var LedgerSigner = /** @class */ (function (_super) {
    ...
    function LedgerSigner(provider, type, path) {
        ...
        ethers.utils.defineReadOnly(_this, "path", path);
        ethers.utils.defineReadOnly(_this, "type", type);
        ethers.utils.defineReadOnly(_this, "provider", provider || null);
        var transport = transports[type];
        if (!transport) {
            logger.throwArgumentError("unknown or unsupported type", "type", type);
        }
        ethers.utils.defineReadOnly(_this, "_eth", transport.create().then(function (transport) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        account = _a.sent();
                        return [2 /*return*/, ethers.utils.getAddress(account.address)];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        messageHex = ethers.utils.hexlify(message).substring(2);
                        return [4 /*yield*/, this._retry(function (eth) { return eth.signPersonalMessage(_this.path, messageHex); })];
                    case 1:
                        sig = _a.sent();
                        sig.r = '0x' + sig.r;
                        sig.s = '0x' + sig.s;
                        return [2 /*return*/, ethers.utils.joinSignature(sig)];
                }
            });
        });
    };
    LedgerSigner.prototype.signTransaction = function (transaction) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, ethers.utils.resolveProperties(transaction)];
                    case 1:
                        tx = _a.sent();
                        baseTx = {
                    ...
                    case 2:
                        sig = _a.sent();
                        return [2 /*return*/, ethers.utils.serializeTransaction(baseTx, {
