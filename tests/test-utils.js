...
describe('Test revert reasons', function() {
    it('should return revert reason', function() {
        var rawData = '';
        var reason = utils.AbiCoder.decodeRevertReason(rawData);

        assert.equal(reason, 'Length must be greater than or equal to 20.');
    });
});
