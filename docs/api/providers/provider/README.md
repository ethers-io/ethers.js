...
// { Promise: { BigNumber: "3446592266910605872" } }</span>
...
// { Promise: "0x000000000000000000000000314159265dd8dbb310642f98f50c066173c1259b" }</span>
...
// { Promise: "registrar.firefly.eth" }</span>

// Lookup an address of an ENS name...
provider.resolveName("ricmoo.firefly.eth");
// { Promise: "0x8ba1f109551bD432803012645Ac136ddd64DBA72" }</span>
```
...
-----
**Content Hash:** 38e58d0fb1f03baf7411d8caa20a5d311d89ebc24c17ac5d42eba5c54d0e9a2e