...
for (var i = 0; i < 2048; i++) {
    ...
    words.cn.push(utf8_1.toUtf8String(bytes));
    var common = s % 4;
    for (var i_1 = common; i_1 < 3; i_1++) {
        bytes[i_1] = codes.indexOf(deltaData[deltaOffset++]) + ((i_1 == 0) ? 228 : 128);
    }
    words.tw.push(utf8_1.toUtf8String(bytes));
}
var LangZh = /** @class */ (function (_super) {
    __extends(LangZh, _super);
    function LangZh(country) {
        var _this = _super.call(this, 'zh_' + country) || this;
        properties_1.defineReadOnly(_this, '_country', country);
        return _this;
    }
