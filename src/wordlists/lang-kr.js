...
function getHangul(code) {
    ...
    //return '[' + ([ 225, (code >> 6) + 132, (code & 0x3f) + 128]).join(', ') + ']';
}
var wordlist = null;
function loadWords() {
    if (wordlist != null) {
...
loadWords();
var LangKr = /** @class */ (function (_super) {
    __extends(LangKr, _super);
    function LangKr() {
        return _super.call(this, 'kr') || this;
    }
    LangKr.prototype.getWord = function (index) {
        loadWords();
    ...
    LangKr.prototype.getWordIndex = function (word) {
        loadWords();
        return wordlist.indexOf(word);
    };
    return LangKr;
}(wordlist_1.Wordlist));
var langKr = new LangKr();
exports.langKr = langKr;
